...
# router.register(r'productos-borrado-masivo', views.ProductoBulkDeleteViewSet, basename='producto-borrado-masivo')
# router.register(r'productos-borrado-masivo', views.ProductoBulkDeleteViewSet)
...
urlpatterns = [
    ...
    path('limpiar-base-de-datos/', views.limpiar_base_de_datos, name='limpiar-base-de-datos'),
